...
from switchbot_lock_logs.models import (
    MODEL_ULTRA, ULTRA_ACTION_MAP, EVENT_TYPES, decode_action, decode_source,
    enrich_log, extract_user_id,
)
...
def test_enrich_log_full_shape():
    log = {"timestamp": 1789383726, "action": 15, "source": 2, "payload": PAYLOADS["ultra_user_10"]}
...
def test_event_types_covered():
    assert "unlock" in EVENT_TYPES and "unknown" in EVENT_TYPES and "failed_attempt" in EVENT_TYPES
